...
<link rel="stylesheet" href="${PATH }/resources/css/zTreeStyle.css" type="text/css" />
...
<script type="text/javascript" src="${PATH }/resources/js/jquery.ztree.all-3.5.min.js"></script>
